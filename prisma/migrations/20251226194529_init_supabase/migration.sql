...
-- CreateEnum
CREATE TYPE "LeaveStatus" AS ENUM ('PENDING_MANAGER', 'PENDING_DIRECTOR', 'APPROVED', 'REJECTED_MANAGER', 'REJECTED_DIRECTOR', 'CANCELLED');
...
CREATE TABLE "LeaveRequest" (
    ...
    "daysCount" DOUBLE PRECISION NOT NULL DEFAULT 1.0,
